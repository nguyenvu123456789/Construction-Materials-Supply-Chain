namespace Application.Constants.Messages
{
    ...
    {
        public const string MSG_REQUIRE_AT_LEAST_ONE_MATERIAL = "Cần ít nhất một vật tư trong báo cáo.";
        public const string MSG_MATERIAL_NOT_FOUND_IN_WAREHOUSE = "Vật tư {0} không tồn tại trong kho {1}.";
        public const string MSG_NOT_ENOUGH_STOCK = "Không đủ tồn kho cho vật tư {0}. Tồn kho: {1}, Yêu cầu: {2}.";
        public const string MSG_MATERIAL_NOT_FOUND = "Vật tư với ID {0} không tồn tại.";
        ...
        public const string MSG_ONLY_PENDING_CAN_BE_REJECTED = "Chỉ có phiếu xuất ở trạng thái Pending mới có thể bị từ chối.";
        ...
        public const string MSG_EXPORT_APPROVED = "Báo cáo đã được duyệt thành công.";
        public const string MSG_MARK_VIEWED = "Đã đánh dấu báo cáo là đã xem.";
    }
}
