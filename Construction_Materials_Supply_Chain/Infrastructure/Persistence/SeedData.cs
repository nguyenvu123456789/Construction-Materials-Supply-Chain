        ...
        public static void Initialize(ScmVlxdContext context)
        {
            ...
            if (!context.Partners.Any())
            {
                ...
                context.Partners.AddRange(
                    ...
                    new Partner { PartnerCode = "P005", PartnerName = "Khách hàng Lê Văn A", PartnerTypeId = customerType.PartnerTypeId, ContactEmail = "levana@customer.vn", ContactPhone = "0915666777", Status = "Active", Region = "Ba Dinh" },
                    new Partner { PartnerCode = "P006", PartnerName = "Công ty xây dựng Sài Gòn", PartnerTypeId = contractorType.PartnerTypeId, ContactEmail = "saigonbuild@contractor.vn", ContactPhone = "0909777888", Status = "Active", Region = "Thanh Xuan" },
